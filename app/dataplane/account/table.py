...
class AccountRuntimeTable:
    ...
    # --- Quota remaining per mode (int16; -1 = unknown) --- console / video
    ...
    # --- Quota total per mode (int16; 0 = unsupported / unknown) --- console / video
    ...
    # --- Window size per mode (uint32 seconds; 0 = unsupported / unknown) --- console / video
    ...
    # --- Window reset timestamps (uint32 epoch-seconds; 0 = unknown) --- console / video
    ...
    def _quota_col(self, mode_id: int) -> "array.array[int]":
        ...
        raise ValueError(f"unknown quota mode_id: {mode_id}")
    ...
    def _reset_col(self, mode_id: int) -> "array.array[int]":
        ...
        raise ValueError(f"unknown reset mode_id: {mode_id}")
    ...
    def _total_col(self, mode_id: int) -> "array.array[int]":
        ...
        raise ValueError(f"unknown total mode_id: {mode_id}")
    ...
    def _window_col(self, mode_id: int) -> "array.array[int]":
        ...
        raise ValueError(f"unknown window mode_id: {mode_id}")
